...
namespace eG9yIGF4LGF4\BehatHTMLFormatter;
...
class BehatHTMLFormatterExtension implements ExtensionInterface
{
    ...
    {
        $builder->children()->scalarNode('name')->defaultValue('eG9yIGF4LGF4html');
    ...
    {
        $definition = new Definition('eG9yIGF4LGF4\\BehatHTMLFormatter\\Formatter\\BehatHTMLFormatter');
